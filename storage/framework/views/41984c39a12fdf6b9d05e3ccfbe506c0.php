                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                ...
                                <select name="movie_id" style="width: 250px" id="movie_id">
                                    ...
                                    <option value="<?php echo e($movie->id); ?>"<?php if($movie->id == old('movie_id', $show->movie_id)): ?> selected <?php endif; ?>  ><?php echo e($movie->name); ?></option>
                             ...
                             <div class="input-field">                               
                                ...
                                <option  value="1" <?php if(1 == old('hall_id', $show->hall_id)): ?> selected <?php endif; ?> >Theater 1</option>      
                                <option  value="2" <?php if(2 == old('hall_id', $show->hall_id)): ?> selected <?php endif; ?> >Theater 2</option>       
                                <option  value="3" <?php if(3 == old('hall_id', $show->hall_id)): ?> selected <?php endif; ?> >Theater 3</option>       
                            ...
                            <div class="input-field">     
                                ...
                                ?>
                                <option  value="<?php echo e($ii); ?>" <?php echo e($duration[0] == $ii ? 'selected' : ''); ?> ><?php echo e($ii); ?> </option>       
                                <?php endfor; ?>
                                </select>
                                </div>
                                <div class="min">
                                ...
                                <select name="min">
                                    ...
                                    $ii = str_pad($i, 2, '0', STR_PAD_LEFT);
                                ?>
                                    <option  value="<?php echo e($ii); ?>" <?php echo e($duration[1] == $ii ? 'selected' : ''); ?>><?php echo e($ii); ?> </option>       
                                    <?php endfor; ?>
                                </select>
                            </div>   
                            </div>
                            ...
                            <div class="input-field">                                
                                ...
                                <input name="date" id="date" type="date" min="" max="" value="<?php echo e($show->date); ?>"/>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\TicketSystem\resources\views/admin/edit_show.blade.php ENDPATH**/ ?>