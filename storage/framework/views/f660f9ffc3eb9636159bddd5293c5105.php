...
?>
    ...
    <div class="row1">
        ...
        <span style="margin-left:160px">
            <?php for($column = 1; $column <= $columns-6; $column++): ?>
        ...
        <span style="margin-left:50px">
            <?php for($column = 1; $column <= $columns-2; $column++): ?>
    ...
    <div class="buttons">
        <a href="/user/bookticket/<?php echo e($shows->id); ?>"><button type="submit" style="margin-left: 250px">Buy</button></a>
       
    </div>
</div>

</form>
  <?php /**PATH C:\xampp\htdocs\TicketSystem\resources\views/components/theater2.blade.php ENDPATH**/ ?>